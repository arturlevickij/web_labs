...
import {
    CartStyled,
    ImageStyled,
    DataInfo, DataButtonStyled, VerticalLine, CartButtonStyled, TotalPrice, CartSyte
} from "./Cart.styled";
        ...
        <div>
            ...
            <CartSyte>
                    ...
                    {filteredStones.map((stone) => (
                        <div key={stone.id}>
                            <DataInfo>
                                ...
                                <DataButtonStyled>
                                    <Button
                                        style={{borderRadius: "10px", background: "#000000", color: "#ffffff", borderColor: "#000000" }}
                ...
                <CartButtonStyled>
                    ...
                    {totalPrice > 0 && <Button style={{borderRadius: "10px", background: "#000000", color: "#ffffff", borderColor: "#000000" }} size={"large"}>BUY ONLINE</Button>}
                </CartButtonStyled>
            </CartSyte>
        </div>
    );
